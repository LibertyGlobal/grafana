...
func syncOrgTeams(user *m.User, extUser *m.ExternalUserInfo) error {
	...
	log.Debug2("Syncing OrgTeams", "login", user.Login, "external", extUser.OrgTeams)
	...
	log.Debug2("Syncing OrgTeams", "login", user.Login, "deleteTeamIds", deleteTeamIds)
	...
	log.Debug2("Syncing OrgTeams", "login", user.Login, "assignTeamNames", assignTeamNames)
	...
	log.Debug2("Syncing OrgTeams", "login", user.Login, "assignTeamIds", assignTeamIds)
...
func syncOrgRoles(user *m.User, extUser *m.ExternalUserInfo) error {
	...
	log.Debug2("Syncing OrgRoles", "login", user.Login, "external", extUser.OrgRoles)
