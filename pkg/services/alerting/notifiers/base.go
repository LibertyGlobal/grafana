...
func NewNotifierBase(model *models.AlertNotification) NotifierBase {
	...
	return NotifierBase{
		...
		DisableWarningMessage:  model.DisableWarningMessage,
...
func (n *NotifierBase) ShouldNotify(ctx context.Context, context *alerting.EvalContext, notiferState *models.AlertNotificationState) bool {
	...
	// Do not notify when state is Warning if DisableWarningMessage is set to true
	if context.Rule.State == models.AlertStateWarning && n.DisableWarningMessage {
		return false
	}
